 ...
 * @since 1.0
 */
/**hibernate SerializationHelper*/
public final class SerializationHelper {

	public static final Logger log = Logger.getLogger( SerializationHelper.class );
	 ...
	 *
	 * @throws FreyjaException (runtime) if the serialization fails
	 */
	public static Object clone(Serializable object) throws FreyjaException {
	 ...
	 * @throws FreyjaException (runtime) if the serialization fails
	 */
	public static void serialize(Serializable obj, OutputStream outputStream) throws FreyjaException {
...
//		}
		...
		try {
			...
			throw new FreyjaException( "could not serialize", ex );
		}
		finally {
			try {
				if ( out != null ) {
	 ...
	 * @throws FreyjaException (runtime) if the serialization fails
	 */
	public static byte[] serialize(Serializable obj) throws FreyjaException {
	 ...
	 * @throws FreyjaException (runtime) if the serialization fails
	 */
	public static Object deserialize(InputStream inputStream) throws FreyjaException {
	 ...
	 * @throws FreyjaException (runtime) if the serialization fails
	 */
	public static Object deserialize(InputStream inputStream, ClassLoader loader) throws FreyjaException {
	...
	public static Object doDeserialize(
			...
			ClassLoader fallbackLoader2) throws FreyjaException {
		if ( inputStream == null ) {
		...
		try {
			...
			try {
				...
				throw new FreyjaException( "could not deserialize", e );
			}
			catch ( IOException e ) {
				throw new FreyjaException( "could not deserialize", e );
			}
	 ...
	 * @throws FreyjaException (runtime) if the serialization fails
	 */
	public static Object deserialize(byte[] objectData) throws FreyjaException {
	 ...
	 * @throws FreyjaException (runtime) if the serialization fails
	 */
	public static Object deserialize(byte[] objectData, ClassLoader loader) throws FreyjaException {
